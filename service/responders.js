...
controllers.Widgets = (function() {
  ...
  Widgets.prototype.get = function(data, credentials, callback) {
    return new models.Widget(this, function(widget) {
      ...
      return widget.create({
        ...
        return widget.find(query, function(res, err) {
          if (err) {
  ...
  Widgets.prototype.some_other_method = function(data, credentials, callback) {
    var response;
    response = {
